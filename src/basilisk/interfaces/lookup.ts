...
export default {
  ...
  /**
   * Lookup20: frame_system::EventRecord<basilisk_runtime::RuntimeEvent,
  ...
  /**
   * Lookup412: pallet_treasury::SpendStatus<AssetKind, AssetBalance,
  ...
  /**
   * Lookup423: pallet_democracy::types::ReferendumInfo<BlockNumber,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall,
  ...
  /**
   * Lookup424: pallet_democracy::types::ReferendumStatus<BlockNumber,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall,
   * sp_runtime::traits::BlakeTwo256>, Balance>
   */
  ...
  /**
   * Lookup426: pallet_democracy::vote::Voting<Balance,
  ...
  /**
   * Lookup442: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32,
  ...
  /**
   * Lookup446: pallet_proxy::Announcement<sp_core::crypto::AccountId32,
  ...
  /**
   * Lookup465: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32,
  ...
  /**
   * Lookup475: pallet_uniques::types::ItemDetails<sp_core::crypto::AccountId32,
   * DepositBalance>
   */
  ...
  /**
   * Lookup483: pallet_identity::types::Registration<Balance, MaxJudgements,
  ...
  /**
   * Lookup492: pallet_identity::types::RegistrarInfo<Balance,
  ...
  /**
   * Lookup499: pallet_multisig::Multisig<BlockNumber, Balance,
  ...
  /**
   * Lookup503: pallet_conviction_voting::vote::Voting<Balance,
  ...
  /**
   * Lookup504: pallet_conviction_voting::vote::Casting<Balance, BlockNumber,
   * PollIndex, MaxVotes>
   */
  ...
  /**
   * Lookup510: pallet_conviction_voting::vote::Delegating<Balance,
  ...
  /**
   * Lookup515: pallet_referenda::types::ReferendumInfo<TrackId,
  ...
  /**
   * Lookup516: pallet_referenda::types::ReferendumStatus<TrackId,
   * basilisk_runtime::OriginCaller, Moment,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall,
   * sp_runtime::traits::BlakeTwo256>, Balance,
   * pallet_conviction_voting::types::Tally<Votes, Total>,
  ...
  /**
   * Lookup536: pallet_scheduler::Scheduled<Name,
   * frame_support::traits::preimages::Bounded<basilisk_runtime::RuntimeCall,
  ...
  /**
   * Lookup603: pallet_asset_registry::types::AssetDetails<AssetId, Balance,
  ...
  /**
   * Lookup613: pallet_marketplace::types::Offer<sp_core::crypto::AccountId32,
   * Balance, BlockNumber>
   */
