...
declare module "@polkadot/api-base/types/events" {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    broadcast: {
       ...
       * Trade executed.
       *
       * Swapped3 is a fixed and renamed version of original Swapped, as Swapped
       * contained wrong input/output amounts for XYK buy trade
       *
       * Swapped3 is a fixed and renamed version of original Swapped3, as
       * Swapped contained wrong filler account on AAVE trades
       */
      Swapped3: AugmentedEvent<
        ApiType,
        [
          swapper: AccountId32,
          filler: AccountId32,
    ...
    circuitBreaker: {
      ...
      AssetCategoryUpdated: AugmentedEvent<
        ApiType,
        [
          assetId: u32,
      ...
      AssetLockdown: AugmentedEvent<
        ApiType,
        [assetId: u32, until: u32],
        { assetId: u32; until: u32 }
      >;
      /** Asset lockdown was removed */
      AssetLockdownRemoved: AugmentedEvent<
        ApiType,
        [assetId: u32],
        { assetId: u32 }
      >;
      /** All reserved amount of deposit was released */
      DepositReleased: AugmentedEvent<
        ApiType,
        [who: AccountId32, assetId: u32],
        { who: AccountId32; assetId: u32 }
      >;
      /** A number of egress accounts added to a list. */
      EgressAccountsAdded: AugmentedEvent<
        ApiType,
        [count: u32],
        { count: u32 }
      >;
      /** A number of egress accounts removed from a list. */
      EgressAccountsRemoved: AugmentedEvent<
        ApiType,
        [count: u32],
        { count: u32 }
      >;
      ...
      WithdrawLimitConfigUpdated: AugmentedEvent<
        ApiType,
        [limit: u128, window: u64],
        { limit: u128; window: u64 }
      >;
      /** Global withdraw lockdown was lifted (either automatically or by reset). */
      WithdrawLockdownLifted: AugmentedEvent<ApiType, []>;
      /** Withdraw lockdown accumulator and states were reset by governance. */
      WithdrawLockdownReset: AugmentedEvent<ApiType, []>;
      /** Global withdraw lockdown was set by governance. */
      WithdrawLockdownTriggered: AugmentedEvent<
        ApiType,
        [until: u64],
        { until: u64 }
      >;
    ...
    convictionVoting: {
      ...
      VoteUnlocked: AugmentedEvent<
        ApiType,
        [who: AccountId32, class_: u16],
        { who: AccountId32; class: u16 }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    };
    ...
    dca: {
      ...
      ReserveUnlocked: AugmentedEvent<
        ApiType,
        [who: AccountId32, assetId: u32],
        { who: AccountId32; assetId: u32 }
      >;
    ...
    dispatcher: {
      AaveManagerCallDispatched: AugmentedEvent<
        ApiType,
        [
          callHash: H256,
          result: Result<
      ...
      >;
      TreasuryManagerCallDispatched: AugmentedEvent<
        ApiType,
        [
          callHash: H256,
          result: Result<
    ...
    dynamicFees: {
      ...
      AssetFeeConfigRemoved: AugmentedEvent<
        ApiType,
        [assetId: u32],
        { assetId: u32 }
      >;
      /** Asset fee configuration has been set */
      AssetFeeConfigSet: AugmentedEvent<
        ApiType,
        [assetId: u32, params: PalletDynamicFeesAssetFeeConfig],
        { assetId: u32; params: PalletDynamicFeesAssetFeeConfig }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    emaOracle: {
      ...
      OracleUpdated: AugmentedEvent<
        ApiType,
        [
          source: U8aFixed,
          assets: ITuple<[u32, u32]>,
    ...
    ethDispenser: {
      ...
      FaucetBalanceUpdated: AugmentedEvent<
        ApiType,
        [oldBalanceWei: u128, newBalanceWei: u128],
        { oldBalanceWei: u128; newBalanceWei: u128 }
      >;
      /**
       * A funding request has been submitted to SigNet.
       *
       * Note: This indicates the request was formed and submitted, not that the
       * EVM transaction has been included on the target chain.
       */
      FundRequested: AugmentedEvent<
        ApiType,
        [requestId: U8aFixed, requester: AccountId32, to: H160, amount: u128],
        { requestId: U8aFixed; requester: AccountId32; to: H160; amount: u128 }
      >;
    ...
    evmAccounts: {
      ...
      AccountClaimed: AugmentedEvent<
        ApiType,
        [account: AccountId32, assetId: u32],
        { account: AccountId32; assetId: u32 }
      >;
      /** Binding was created. */
      ...
      ContractApproved: AugmentedEvent<
        ApiType,
        [address: H160],
        { address: H160 }
      >;
      /** Contract was disapproved. */
      ContractDisapproved: AugmentedEvent<
        ApiType,
        [address: H160],
        { address: H160 }
      >;
    ...
    hsm: {
       ...
       */
      ArbitrageExecuted: AugmentedEvent<
        ApiType,
        [arbitrage: u8, assetId: u32, hollarAmount: u128, profit: u128],
        { arbitrage: u8; assetId: u32; hollarAmount: u128; profit: u128 }
      >;
      /**
       ...
       */
      CollateralRemoved: AugmentedEvent<
        ApiType,
        [assetId: u32],
        { assetId: u32 }
      >;
       ...
       * - `max_buy_price_coefficient`: New max buy price coefficient if updated
       *   (None if not changed)
       ...
       */
      CollateralUpdated: AugmentedEvent<
        ApiType,
        [
          assetId: u32,
    ...
    identity: {
      ...
      UsernameRemoved: AugmentedEvent<
        ApiType,
        [username: Bytes],
        { username: Bytes }
      >;
      ...
      UsernameUnbound: AugmentedEvent<
        ApiType,
        [username: Bytes],
        { username: Bytes }
      >;
    ...
    lbp: {
      /** Purchase executed. Deprecated. Replaced by pallet_broadcast::Swapped */
      ...
      PoolUpdated: AugmentedEvent<
        ...
        { pool: AccountId32; data: PalletLbpPool }
      >;
      /** Sale executed. Deprecated. Replaced by pallet_broadcast::Swapped */
    ...
    liquidation: {
      ...
      Liquidated: AugmentedEvent<
        ApiType,
        [user: H160, collateralAsset: u32, debtAsset: u32, profit: u128],
        { user: H160; collateralAsset: u32; debtAsset: u32; profit: u128 }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    multiBlockMigrations: {
       ...
       * A Migration failed.
       *
       * This implies that the whole upgrade failed and governance intervention
       * is required.
       */
      MigrationFailed: AugmentedEvent<
        ApiType,
        [index: u32, took: u32],
        { index: u32; took: u32 }
      >;
    ...
    omnipool: {
      ...
      AssetWeightCapUpdated: AugmentedEvent<
        ...
        { assetId: u32; cap: Permill }
      >;
      /** Buy trade executed. Deprecated. Replaced by pallet_broadcast::Swapped */
      BuyExecuted: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
      ...
      >;
      /** Sell trade executed. Deprecated. Replaced by pallet_broadcast::Swapped */
      SellExecuted: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
    ...
    ormlXcm: {
      ...
      Sent: AugmentedEvent<
        ApiType,
        [to: StagingXcmV5Location, message: StagingXcmV5Xcm],
        { to: StagingXcmV5Location; message: StagingXcmV5Xcm }
      >;
      /** Generic event */
      [key: string]: AugmentedEvent<ApiType>;
    ...
    otc: {
      ...
      /**
       * An Order has been completely filled Deprecated. Replaced by
       * pallet_broadcast::Swapped
       */
      ...
      >;
      /**
       * An Order has been partially filled Deprecated. Replaced by
       * pallet_broadcast::Swapped
       */
    ...
    polkadotXcm: {
      ...
      >;
      /**
       * An `aliaser` location was authorized by `target` to alias it,
       * authorization valid until `expiry` block number.
       */
    ...
    scheduler: {
      ...
      >;
      /**
       * The given task was unable to be retried since the agenda is full at
       * that block or there was not enough weight to reschedule it.
       */
    ...
    signet: {
      ...
      DepositUpdated: AugmentedEvent<
        ApiType,
        [oldDeposit: u128, newDeposit: u128],
        { oldDeposit: u128; newDeposit: u128 }
      >;
      /** Funds have been withdrawn from the pallet */
      FundsWithdrawn: AugmentedEvent<
        ApiType,
        [amount: u128, recipient: AccountId32],
        { amount: u128; recipient: AccountId32 }
      >;
      /** Pallet has been initialized with an admin */
      Initialized: AugmentedEvent<
        ApiType,
        [admin: AccountId32, signatureDeposit: u128, chainId: Bytes],
        { admin: AccountId32; signatureDeposit: u128; chainId: Bytes }
      >;
      /** Respond bidirectional event */
      RespondBidirectionalEvent: AugmentedEvent<
        ApiType,
        [
          requestId: U8aFixed,
      ...
      SignatureError: AugmentedEvent<
        ApiType,
        [requestId: U8aFixed, responder: AccountId32, error: Bytes],
        { requestId: U8aFixed; responder: AccountId32; error: Bytes }
      >;
      /** A signature has been requested */
      SignatureRequested: AugmentedEvent<
        ApiType,
        [
          sender: AccountId32,
          payload: U8aFixed,
      ...
      SignatureResponded: AugmentedEvent<
        ApiType,
        [
          requestId: U8aFixed,
          responder: AccountId32,
      ...
      SignBidirectionalRequested: AugmentedEvent<
        ApiType,
        [
          sender: AccountId32,
    ...
    stableswap: {
       ...
       * included in amount_in). Deprecated. Replaced by pallet_broadcast::Swapped
       */
      BuyExecuted: AugmentedEvent<
        ApiType,
        [
      ...
      PoolMaxPegUpdateUpdated: AugmentedEvent<
        ApiType,
        [poolId: u32, maxPegUpdate: Perbill],
        { poolId: u32; maxPegUpdate: Perbill }
      >;
      /** Pool peg source has been updated. */
      PoolPegSourceUpdated: AugmentedEvent<
        ApiType,
        [poolId: u32, assetId: u32, pegSource: PalletStableswapPegSource],
        { poolId: u32; assetId: u32; pegSource: PalletStableswapPegSource }
      >;
      /**
       * Sell trade executed. Trade fee paid in asset leaving the pool (already
       * subtracted from amount_out). Deprecated. Replaced by pallet_broadcast::Swapped
       */
      SellExecuted: AugmentedEvent<
        ApiType,
        [
    ...
    xyk: {
      /** Asset purchase executed. Deprecated. Replaced by pallet_broadcast::Swapped */
      BuyExecuted: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
      ...
      >;
      /** Asset sale executed. Deprecated. Replaced by pallet_broadcast::Swapped */
      SellExecuted: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
