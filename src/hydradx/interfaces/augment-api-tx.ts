...
declare module "@polkadot/api-base/types/submittable" {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    dca: {
       ...
       * initial `total_amount` allocation.
       *
    ...
    elections: {
       ...
       * above roles. The type of renouncing must be provided as witness data.
       *
       * ## Complexity
       *
    ...
    stableswap: {
       ...
       * that this does not seed the pool with liquidity. Use `add_liquidity` to
      ...
      removeLiquidity: AugmentedSubmittable<
        ...
        [u32, u128, Vec<PalletStableswapAssetAmount>]
      >;
      /**
    ...
    tips: {
       ...
       *   length `T`. `T` is charged as upper bound given by
       ...
       *
       * - `O(T)` where `T` is the number of tippers. decoding `Tipper` vec of
       *   length `T`, insert tip and check closing, `T` is charged as upper
    ...
    treasury: {
       ...
       * ## Details
       *
       * At a later time, the proposal will be allocated to the beneficiary and
       * the original deposit will be returned.
       *
       * ### Complexity
       *
       * - O(1).
       ...
       * ## Details
       *
       * A deposit proportional to the value is reserved and slashed if the
       * proposal is rejected. It is returned once the proposal is awarded.
       *
       * ### Complexity
       *
       * - O(1)
